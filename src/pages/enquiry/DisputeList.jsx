...
const DisputeList = () => {
  ...
  const [isLoadingDisputeList, setIsLoadingDisputeList] = useState(false);
  ...
  useEffect(() => {
    setIsLoadingDisputeList(true);
    setTimeout(() => {
      setIsLoadingDisputeList(false);
    }, 1000);
  }, []);
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <h2 className="text-lg font-semibold text-darkBlueText">
          Dispute List ({mockDisputeList?.length})
        </h2>
      ...
      <div className="w-full overflow-x-auto rounded-lg border">
        <EnhancedTable
          pagination
          columns={columns}
          data={mockDisputeList}
          searchQuery={searchQuery}
          isLoading={isLoadingDisputeList}
