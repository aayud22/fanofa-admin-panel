...
const mockComplaintsList = [
  {
    ...
    adminNote: 'Lorem ipsum dolor sit amet...',
    attachment: '2 Files',
...
const ComplaintsList = () => {
  ...
  const [isLoadingComplaintsList, setIsLoadingComplaintsList] = useState(false);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setIsLoadingComplaintsList(false);
    }, 1000);
  }, []);
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: false,
      render: (value) => (
        <div className="flex items-center text-sm font-medium text-deepIndigo">
          <File className="fill-oceanBlue stroke-white outline-white" />
          {value}
        </div>
      ),
    },
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <h2 className="text-lg font-semibold text-darkBlueText">
          Complaints List ({mockComplaintsList?.length})
        </h2>
